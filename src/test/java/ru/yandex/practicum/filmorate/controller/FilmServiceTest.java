...
class FilmServiceTest {
    ...
    void testGetFilms() {
        ...
        films.add(new Film(1, "film", "newFilm", LocalDate.now(), 90, null));
        films.add(new Film(2, "film", "newFilm", LocalDate.now(), 90, null));
    ...
    @Test
    void testCreate() {
        Film film = new Film(1, "film", "newFilm", LocalDate.now(), 90, null);
    ...
    void testGetPopularFilms() {
        List<Film> films = new ArrayList<>();
        films.add(new Film(1, "film1", "newFilm1", LocalDate.now(), 90, null));
        films.add(new Film(2, "film2", "newFilm2", LocalDate.now(), 90, null));
        films.add(new Film(3, "film3", "newFilm3", LocalDate.now(), 90, null));
